...
final class DefaultsTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        suiteName = "brushy.defaults.tests.\(UUID().uuidString)"
    ...
    /// here does — nearly everything targets `BrushyDocument` and reaches
    ...
    func testSettingsMenuItemIsAppScopedAndOnCommandComma() {
        ...
        XCTAssertFalse(BrushyDocument.instancesRespond(to: action),
