...
# Builds Brushy in Release, signs with Developer ID (including Sparkle's nested
...
#   NOTARY_PROFILE          notarytool keychain profile name (default: brushy-notary)
...
NOTARY_PROFILE="${NOTARY_PROFILE:-brushy-notary}"
SKIP_NOTARIZE="false"
VERSION=""
...
VERSION="${VERSION#v}"
ZIP_PATH="dist/Brushy-${VERSION}-macos.zip"
