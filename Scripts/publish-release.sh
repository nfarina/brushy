...
git add Brushy.xcodeproj/project.pbxproj docs/appcast.xml
...
echo "Published ${TAG}."
echo "  Zip:     ${ZIP_PATH}"
echo "  Release: https://github.com/nfarina/brushy/releases/tag/${TAG}"
echo "  Feed:    https://nfarina.github.io/brushy/appcast.xml"
