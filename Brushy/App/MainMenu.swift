...
enum MainMenuBuilder {
    static func build() -> NSMenu {
        ...
        // BrushyDocument — so ⌘, works with zero documents open.
        ...
        let export = file.addItem(withTitle: "Export…",
                                  action: #selector(BrushyDocument.exportFlattened(_:)),
                                  keyEquivalent: "S")
        ...
        // otherwise they fall through the chain to BrushyDocument.
        edit.addItem(withTitle: "Cut", action: #selector(BrushyDocument.cut(_:)),
                     keyEquivalent: "x")
        edit.addItem(withTitle: "Copy", action: #selector(BrushyDocument.copy(_:)),
                     keyEquivalent: "c")
        let copyMerged = edit.addItem(withTitle: "Copy Merged",
                                      action: #selector(BrushyDocument.copyMerged(_:)),
                                      keyEquivalent: "C")
        copyMerged.keyEquivalentModifierMask = [.command, .shift]
        edit.addItem(withTitle: "Paste", action: #selector(BrushyDocument.paste(_:)),
                     keyEquivalent: "v")
        let pasteInto = edit.addItem(withTitle: "Paste Into",
                                     action: #selector(BrushyDocument.pasteInto(_:)),
                                     keyEquivalent: "v")
        ...
        edit.addItem(withTitle: "Free Transform",
                     action: #selector(BrushyDocument.freeTransform(_:)), keyEquivalent: "t")
        edit.addItem(.separator())
        ...
        let fill = edit.addItem(withTitle: "Fill…",
                                action: #selector(BrushyDocument.showFill(_:)),
        ...
        layer.addItem(withTitle: "Layer via Copy",
                      action: #selector(BrushyDocument.layerViaCopy(_:)), keyEquivalent: "j")
        let viaCut = layer.addItem(withTitle: "Layer via Cut",
                                   action: #selector(BrushyDocument.layerViaCut(_:)),
                                   keyEquivalent: "J")
        viaCut.keyEquivalentModifierMask = [.command, .shift]
        layer.addItem(withTitle: "Duplicate Layer",
                      action: #selector(BrushyDocument.duplicateLayer(_:)), keyEquivalent: "")
        ...
        let duplicateTo = layer.addItem(
            ...
            action: #selector(BrushyDocument.duplicateLayerToDocument(_:)),
            keyEquivalent: "")
        ...
        for kind in ["Levels", "Curves", "Hue/Saturation"] {
            let item = adjustments.addItem(withTitle: "\(kind)…",
                                           action: #selector(BrushyDocument.newAdjustmentLayer(_:)),
                                           keyEquivalent: "")
        ...
        layer.addItem(withTitle: "Edit Adjustment…",
                      action: #selector(BrushyDocument.editAdjustment(_:)), keyEquivalent: "")
        layer.addItem(.separator())
        ...
        layer.addItem(withTitle: "Rasterize Layer",
                      action: #selector(BrushyDocument.rasterizeLayer(_:)), keyEquivalent: "")
        layer.addItem(withTitle: "Merge Down",
                      action: #selector(BrushyDocument.mergeDown(_:)), keyEquivalent: "e")
        layer.addItem(withTitle: "Delete Layer",
                      action: #selector(BrushyDocument.deleteLayer(_:)), keyEquivalent: "")
        layer.addItem(.separator())
        ...
        layer.addItem(withTitle: "Group Layer",
                      action: #selector(BrushyDocument.groupLayer(_:)), keyEquivalent: "g")
        let ungroup = layer.addItem(withTitle: "Ungroup",
                                    action: #selector(BrushyDocument.ungroupLayer(_:)),
                                    keyEquivalent: "G")
        ...
        for edge in AlignEdge.allCases {
            let item = align.addItem(withTitle: edge.displayName,
                                     action: #selector(BrushyDocument.alignLayers(_:)),
                                     keyEquivalent: "")
        ...
        for command in DistributeCommand.allCases {
            let item = distribute.addItem(withTitle: command.displayName,
                                          action: #selector(BrushyDocument.distributeLayers(_:)),
                                          keyEquivalent: "")
        ...
        layer.addItem(withTitle: "Flip Horizontal",
                      action: #selector(BrushyDocument.flipHorizontal(_:)), keyEquivalent: "")
        layer.addItem(withTitle: "Flip Vertical",
                      action: #selector(BrushyDocument.flipVertical(_:)), keyEquivalent: "")
        layer.addItem(withTitle: "Rotate 90° Left",
                      action: #selector(BrushyDocument.rotate90Left(_:)), keyEquivalent: "")
        ...
        style.addItem(withTitle: "Clear Layer Style",
                      action: #selector(BrushyDocument.clearLayerStyle(_:)),
                      keyEquivalent: "")
        ...
        layer.addItem(withTitle: "Add Layer Mask",
                      action: #selector(BrushyDocument.addLayerMask(_:)), keyEquivalent: "")
        layer.addItem(withTitle: "Delete Layer Mask",
                      action: #selector(BrushyDocument.deleteLayerMask(_:)), keyEquivalent: "")
        layer.addItem(withTitle: "Enable/Disable Layer Mask",
                      action: #selector(BrushyDocument.toggleLayerMask(_:)), keyEquivalent: "")
        layer.addItem(.separator())
        ...
        let clippingMask = layer.addItem(
            ...
            action: #selector(BrushyDocument.toggleClippingMask(_:)),
            keyEquivalent: "g")
        ...
        // BrushyDocument.selectAll: a focused text view claims it first,
        // so text fields keep select-all-text.
        select.addItem(withTitle: "All",
                       action: #selector(BrushyDocument.selectAll(_:)), keyEquivalent: "a")
        select.addItem(withTitle: "Deselect",
                       action: #selector(BrushyDocument.deselect(_:)), keyEquivalent: "d")
        let inverse = select.addItem(withTitle: "Inverse",
                                     action: #selector(BrushyDocument.invertSelection(_:)),
                                     keyEquivalent: "I")
        ...
        select.addItem(withTitle: "Select Subject",
                       action: #selector(BrushyDocument.selectSubject(_:)),
                       keyEquivalent: "")
        select.addItem(.separator())
        let modify = NSMenu(title: "Modify")
        modify.addItem(withTitle: "Grow…",
                       action: #selector(BrushyDocument.showGrowSelection(_:)),
                       keyEquivalent: "")
        modify.addItem(withTitle: "Contract…",
                       action: #selector(BrushyDocument.showContractSelection(_:)),
                       keyEquivalent: "")
        modify.addItem(withTitle: "Border…",
                       action: #selector(BrushyDocument.showBorderSelection(_:)),
                       keyEquivalent: "")
        ...
        select.addItem(withTitle: "Edit in Quick Mask Mode",
                       action: #selector(BrushyDocument.toggleQuickMask(_:)),
                       keyEquivalent: "")
        select.addItem(.separator())
        select.addItem(withTitle: "Transform Selection",
                       action: #selector(BrushyDocument.transformSelection(_:)),
                       keyEquivalent: "")
        ...
        view.addItem(withTitle: "Zoom In",
                     action: #selector(BrushyDocument.zoomIn(_:)), keyEquivalent: "=")
        view.addItem(withTitle: "Zoom Out",
                     action: #selector(BrushyDocument.zoomOut(_:)), keyEquivalent: "-")
        view.addItem(withTitle: "Fit on Screen",
                     action: #selector(BrushyDocument.zoomToFit(_:)), keyEquivalent: "0")
        view.addItem(withTitle: "Actual Size (100%)",
                     action: #selector(BrushyDocument.zoomToActualSize(_:)), keyEquivalent: "1")
        // Rulers, guides, grid, snapping. Checkmarks are refreshed
        // in BrushyDocument.validateUserInterfaceItem.
        view.addItem(.separator())
        view.addItem(withTitle: "Show Rulers",
                     action: #selector(BrushyDocument.toggleRulers(_:)), keyEquivalent: "r")
        view.addItem(withTitle: "Show Guides",
                     action: #selector(BrushyDocument.toggleGuides(_:)), keyEquivalent: ";")
        let lockGuides = view.addItem(withTitle: "Lock Guides",
                                      action: #selector(BrushyDocument.toggleLockGuides(_:)),
                                      keyEquivalent: ";")
        lockGuides.keyEquivalentModifierMask = [.command, .option]
        view.addItem(withTitle: "Clear Guides",
                     action: #selector(BrushyDocument.clearGuides(_:)), keyEquivalent: "")
        view.addItem(withTitle: "Show Grid",
                     action: #selector(BrushyDocument.toggleGrid(_:)), keyEquivalent: "'")
        ...
        view.addItem(withTitle: "Hide Panels",
                     action: #selector(BrushyDocument.togglePanels(_:)), keyEquivalent: "")
