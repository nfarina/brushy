...
final class ScriptHostTests: XCTestCase {
    ...
    func testDrawRecordsCanvasCallsIntoOneOp() throws {
        ...
        let px = try rawRGBA8(layer.source, in: DezzyColorSpace.sRGB)
