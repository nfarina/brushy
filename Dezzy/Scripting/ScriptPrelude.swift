...
/// (`dezzy`, `Doc`, `Layer`, `Group`), implemented over one host function
...
(function (global) {
  ...
  Object.defineProperty(global, "doc", { get: function () { return dezzy.document; }, configurable: true });
  global.__dezzyRun = function (fn) {
    const v = fn();
