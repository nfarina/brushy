...
enum ScriptAPIDeclaration {
    static let source = #"""
// Dezzy scripting API. Scripts run synchronously against a snapshot of the
...
declare const doc: Doc;                   // shorthand for dezzy.document
...
declare class Doc {
  ...
  addImage(image: string, opts?: { x?: number; y?: number; width?: number; height?: number;
      ...
      // Places an image id from dezzy.loadImage or the generate tool. Default: centred, scaled
...
declare class Layer {
  ...
  readonly paintable: boolean;              // true for layers made in Dezzy; imported photos are not
